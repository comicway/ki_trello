...
This document contains the rules and guidelines for developing and maintaining the **Ki Trello** project. The goal is to ensure high-quality, efficient, and easily maintainable code.
...
*   **Language**: React
*   **Purpose**: Take the Ki Trello application to a production environment with real users.
